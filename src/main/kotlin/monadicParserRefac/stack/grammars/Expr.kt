...
import monadicParserRefac.stack.grammars.Expr.E
...
//    return "Term('$op', $left, $right)"
  ...
  data object E : BaseParser<Expr, State<String>>() {
  ...
  data object T : BaseParser<Term, State<String>>() {
  ...
  data object F : BaseParser<FF, State<String>>() {
